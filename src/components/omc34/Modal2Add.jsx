  ...
  return (
    <Fragment>
        ...
        <div className='modalContainer'>
            ...
            <div className='headerTittle'>Registrar concepto para la norma Omniclass 34: Roles Organizacionales Nivel {props.numeroTabla}</div>
            {
              props.numeroTabla>1?(
                ...
                <table {...getTableProps()} style={{maxHeight:'100px'}} className='table table-hover mt-2 shadow-lg'>
                    ...
                    <tbody {...getTableBodyProps()}>
                        ...
                        return (
                        <tr className='omc34Modal' style={{fontSize:'12px', fontFamily:'arial'}} {...row.getRowProps()} onClick={(e)=>(selectRow(e),props.selectFk(row.original.Codigo)) }>{row.cells.map(cell => {
                        return (
