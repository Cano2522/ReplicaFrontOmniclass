...
function Modal2Add(props) {
  ...
  //react hook forms
    ...
    const {CreateOmc41Url} = useOmc41()
    
  //ESTILOS CSS PARA SELECCIONAR FILA 
        function cleanTr(){
          document.querySelectorAll('.omc41Modal').forEach(function(index){
...
//fuinciones de la tabla
    ...
    const onSubmit = (data,e)=>{
      ...
      CreateOmc41Url(data,props.numeroTabla,props.select)
      reset({})
  ...
  return (
    <Fragment>
        ...
        <div className='modalContainer'>
            ...
            <div className='headerTittle'>Registrar concepto para la norma Omniclass 41: Materiales Nivel {props.numeroTabla}</div>
            {
              props.numeroTabla>1?(
                ...
                <table {...getTableProps()} style={{maxHeight:'100px'}} className='table table-hover mt-2 shadow-lg'>
                    ...
                    <tbody {...getTableBodyProps()}>
                        ...
                        return (
                        <tr className='omc41Modal' style={{fontSize:'12px', fontFamily:'arial'}} {...row.getRowProps()} onClick={(e)=>(selectRow(e),props.selectFk(row.original.Codigo)) }>{row.cells.map(cell => {
                        return (
