...
export default function Omcn5(props){
      ...
      function cleanTr(){
        document.querySelectorAll('.trN5').forEach(function(index){
   ...
   const tableHooks = (hooks)=>{
    hooks.visibleColumns.push((columns)=>[
      ...columns,{
        ...
        Header:'Editar',
        Cell:({row})=>(
          <button type='button' style={{marginTop:'20%'}} className='btn btn-success' data-bs-toggle="modal" data-bs-target='#modalEditar' onClick={()=>props.edidrow(5,row.values)}> Editar</button>
     ...
     return(
      <div className='containerTable mt-4'>
        <div className='headerTable ' >
          <div className='col-md-7 col-sm-5' ><h2 className='mt-3 textTable'>OMC Nivel 5</h2></div>
