...
function Modal2Add(props) {
  ...
  //react hook forms
    ...
    const {CreateOmc35Url} = useOmc35()
    
  //ESTILOS CSS PARA SELECCIONAR FILA 
        function cleanTr(){
          document.querySelectorAll('.omc35Modal').forEach(function(index){
...
//fuinciones de la tabla
    ...
    const onSubmit = (data,e)=>{
      ...
      CreateOmc35Url(data,props.numeroTabla,props.select)
      reset({})
  ...
  return (
    <Fragment>
        ...
        <div className='modalContainer'>
            ...
            <div className='headerTittle'>Registrar concepto para la norma Omniclass 35: Herramienta y Equipo Nivel {props.numeroTabla}</div>
            {
              props.numeroTabla>1?(
                ...
                <table {...getTableProps()} style={{maxHeight:'100px'}} className='table table-hover mt-2 shadow-lg'>
                    ...
                    <tbody {...getTableBodyProps()}>
                        ...
                        return (
                        <tr className='omc35Modal' style={{fontSize:'12px', fontFamily:'arial'}} {...row.getRowProps()} onClick={(e)=>(selectRow(e),props.selectFk(row.original.Codigo)) }>{row.cells.map(cell => {
                        return (
       ...
       <div className="row InputAdd">
        <div className="form-group col-md-6">
         ...
         <input type="text" maxLength='15' className="form-control" id="inputEmail4" {...register("Codigo",{required:true,minLength:9})} placeholder="Código"/>
