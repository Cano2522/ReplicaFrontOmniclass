...
export function Omc34Provider(props) {
  ...
  const selectOpp =(data, dataApi) => {
    ...
    if(dataApi!=null){setdataomcn2(dataApi.filter((dato) => dato.fk_Omc34N1 === selectid[0].idOmc34N1))}else{
      setdataomcn2(omc34n2.filter((dato) => dato.fk_Omc34N1 === selectid[0].idOmc34N1))
    }
    setdataomcn3([]);
    setdataomcn4([]);
  };
  ...
  const CreateOmc34Url = async (Data, idtabla, Codigo) => {
    switch (idtabla) {
      case 1:
        axios
          .post(`http://localhost:8000/apiOMC34/OMC34Nivel${idtabla}/`, {
            Codigo: Data.Codigo,
  ...
  const UpdateOmc34Url = async (idtabla, id, Data, fk) => {
    switch (idtabla) {
      case 1:
        axios
          .put(`http://localhost:8000/apiOMC34/OMC34Nivel1/${id}/`, {
            Codigo: Data.Codigo,
            anioReg: Data.anioReg,
            definicionEng: Data.definicionEng,
            definicionSpa: Data.definicionSpa,
      ...
      case 2:
        axios
          .put(`http://localhost:8000/apiOMC34/OMC34Nivel2/${id}/`, {
            Codigo: Data.Codigo,
            anioReg: Data.anioReg,
            definicionEng: Data.definicionEng,
            definicionSpa: Data.definicionSpa,
      ...
      case 3:
        axios
          .put(`http://localhost:8000/apiOMC34/OMC34Nivel3/${id}/`, {
            Codigo: Data.Codigo,
            anioReg: Data.anioReg,
            definicionEng: Data.definicionEng,
            definicionSpa: Data.definicionSpa,
      ...
      case 4:
        axios
          .put(`http://localhost:8000/apiOMC34/OMC34Nivel4/${id}/`, {
            Codigo: Data.Codigo,
            anioReg: Data.anioReg,
            definicionEng: Data.definicionEng,
            definicionSpa: Data.definicionSpa,
